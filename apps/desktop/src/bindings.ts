...
export const commands = {
  async startRecording(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("start_recording", { settings }),
      };
    } catch (e) {
  ...
  async stopRecording(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("stop_recording", { appName, style }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async checkSttModelStatus(
    model: SttModel,
  ): Promise<Result<SttModelStatus, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("check_stt_model_status", { model }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async downloadSttModel(model: SttModel): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("download_stt_model", { model }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async checkLlmModelStatus(
    model: LlmModel,
  ): Promise<Result<LlmModelStatus, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("check_llm_model_status", { model }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async downloadLlmModel(model: LlmModel): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("download_llm_model", { model }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeShortcut(key: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_shortcut", { key }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async keytermsList(
    category: KeytermCategory | null,
  ): Promise<Result<Keyterm[], CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("keyterms_list", { category }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async keytermsCreate(
    input: CreateKeytermInput,
  ): Promise<Result<Keyterm, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("keyterms_create", { input }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async keytermsUpdate(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("keyterms_update", { id, input }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async keytermsDelete(id: string): Promise<Result<null, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("keyterms_delete", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async settingsGet(
    key: string,
  ): Promise<Result<Setting | null, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("settings_get", { key }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async settingsSet(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("settings_set", { input }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async settingsDelete(key: string): Promise<Result<null, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("settings_delete", { key }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  ): Promise<Result<string | null, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("keys_vault_get", { service }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async keysVaultSet(input: SetKeyInput): Promise<Result<null, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("keys_vault_set", { input }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   * Delete an API key
   */
  async keysVaultDelete(
    service: VaultService,
  ): Promise<Result<null, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("keys_vault_delete", { service }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async transcriptionsList(
    params: ListTranscriptionsParams | null,
  ): Promise<Result<PaginatedTranscriptions, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("transcriptions_list", { params }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async transcriptionsGet(
    id: string,
  ): Promise<Result<Transcription, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("transcriptions_get", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async transcriptionsCreate(
    input: CreateTranscriptionInput,
  ): Promise<Result<Transcription, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("transcriptions_create", { input }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async transcriptionsUpdate(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("transcriptions_update", { id, input }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async transcriptionsDelete(id: string): Promise<Result<null, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("transcriptions_delete", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async transcriptionsAnalytics(): Promise<
    Result<TranscriptionAnalytics, CommandError>
  > {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("transcriptions_analytics"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  ): Promise<Result<Note, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("notes_create", { input }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async notesUpdate(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("notes_update", { id, input }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  ): Promise<Result<Shortcut[], CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("shortcuts_list", { category }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async shortcutsGet(id: string): Promise<Result<Shortcut, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("shortcuts_get", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async shortcutsCreate(
    input: CreateShortcutInput,
  ): Promise<Result<Shortcut, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("shortcuts_create", { input }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async shortcutsUpdate(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("shortcuts_update", { id, input }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async shortcutsDelete(id: string): Promise<Result<null, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("shortcuts_delete", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async writingStylesGet(
    category: WritingStyleCategory,
  ): Promise<Result<WritingStyle, CommandError>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("writing_styles_get", { category }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async writingStylesUpdate(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("writing_styles_update", { category, input }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
 ...
 */
export type KeyVaultEntryMasked = {
  service: string;
  type: string;
  has_key: boolean;
  created_at: number;
...
export type UpdateKeytermInput = {
  text: string | null;
  category: KeytermCategory | null;
};
...
export type UpdateWritingStyleInput = {
