    ...
    return (
      <div className="relative flex flex-1 items-center">
        ...
        {showTrigger && (
          <ComboboxTrigger
            className={cn(
              "absolute end-1 inline-flex size-6 shrink-0 cursor-pointer items-center justify-center rounded-md border border-transparent opacity-80 outline-none transition-opacity hover:opacity-100 sm:size-5 [&_svg:not([class*='size-'])]:size-4 sm:[&_svg:not([class*='size-'])]:size-3.5 [&_svg]:pointer-events-none [&_svg]:shrink-0",
            )}
          >
            <ChevronsUpDownIcon />
          </ComboboxTrigger>
